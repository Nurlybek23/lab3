...
<head>
    ...
    <!-- <link rel="stylesheet" href=" {{asset('asset/css/style.css) }}" > href="{{ asset('asset/CSSFolder/Portfolio.css') }}"
        ...
        <div class="container">
            ...
            <div class="row">
                       <div class="card" style="width: 18rem;">
                            <img src="pacman.png" width="300" height="200" class="card-img-top" alt="...">
                               <div class="card-body">
                        ...
                        <div class="card" style="width: 18rem;">
                            <img src="pizza.jpg" width="300" height="200" class="card-img-top" alt="...">
                            <div class="card-body">
                        ...
                        <div class="card" style="width: 18rem;">
                            <img src="car.jpg" width="300" height="200" class="card-img-top" alt="...">
                            <div class="card-body">
